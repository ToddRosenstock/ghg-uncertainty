...
ggplot(data=slices, aes(Values, fill=Level)) +
 geom_density(alpha=.2) +
  ylab("Relative probability") +
    xlab(expression(Emission~intensity~of~milk~production~at~specific~milk~yield~per~capita~(kg~CO[2]*'-eq'~kg^-1))) + labs(fill='Production level') + theme_bw()  



ggsave("Fig_8_emission_density_all_farms.png", width=7,height=5)
...
ggsave("Fig_14_no_bulls_scatter_per_head_milk_emissions_intensity.png",width=9,height=9)
...
save_temperature_scenarios(breed_res_endline,"results","Breed_intervention_endline")
```

```{r, include=FALSE}
adoption_rate <- 1
breed_res_endline<-load_temperature_scenarios("results","Breed_intervention_endline")
...
ggsave("Fig_19_breed_endline.png", width=9,height=9)
...
ggsave("Fig_20_breed_endline_errors.png", width=5,height=5)
...
save_temperature_scenarios(nobull_res_endline,"results","Nobull_intervention_endline")
```

```{r, include=FALSE}
adoption_rate <- 1
nobull_res_endline<-load_temperature_scenarios("results","Nobull_intervention_endline")
...
ggsave("Fig_21_nobull_endline.png", width=9,height=9)
...
ggsave("Fig_22_nobull_endline_errors.png", width=5,height=5)
...
save_temperature_scenarios(lessReplace_res_endline,"results","lessReplace_intervention_endline")
```

```{r, include=FALSE}
lessReplace_res_endline<-load_temperature_scenarios("results","lessReplace_intervention_endline")
...
ggsave("Fig_23_lessReplace_endline.png", width=9,height=9)
...
ggsave("Fig_24_lessReplace_endline_errors.png", width=5,height=5)
