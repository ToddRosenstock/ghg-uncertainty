...
```{r, fig.show="hold", fig.cap="No bulls intervention (left) vs. baseline (right)", message=FALSE, warning=FALSE}
...
plot_nobull + plot_baseline + dens_nobull + dens_baseline +
  plot_layout(ncol = 2, nrow = 2) + guides(fill="none")

ggsave("Fig_12_no_bulls_scatter_per_head_milk_emissions_intensity.png",width=9,height=9)
...
ggsave("Fig_13_impact_of_nobull_reductions.png")
...
ggsave("Fig_14_lessReplace_reductions.png")
