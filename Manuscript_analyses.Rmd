...
We define subgroups based on the populations of households described by a household survey in Kenya [@wilkes_variation_2020; @wilkes_methods_2019]. Each of the farms encountered in this survey were converted into one scenario, for which Monte Carlo simulation is then used to produce multiple replicates.

# Household-based scenarios

The information for the household is extracted from a spreadsheet that contains all the survey responses [@wilkes_variation_2020; @wilkes_methods_2019]. Extracting all relevant information from these spreadsheets is a slightly complex task, which is accomplished by the following code.
...
We'll also make precise scenarios that contain only the exact values that were observed in the survey.
...
precise_estimates<-c("Ca_pasture","Ca_large_grazing","C_intact_males","C_castrates","C_females","maintenance_coefficient_Cfi_other",
                     "maintenance_coefficient_Cfi_lact_cow","maintenance_coefficient_Cfi_bulls","mature_weight_MW_female","mature_weight_MW_male",
                     "milk_fat","Cp_rate_4","Cp_rate_5","Cp_rate_6","Y_m","Bo_animaltype_1","Bo_animaltype_2","Bo_animaltype_3","Bo_animaltype_4",
                     "Bo_animaltype_5","Bo_animaltype_6","Bo_animaltype_7","Bo_animaltype_8","Bo_animaltype_9","Bo_animaltype_10","Bo_animaltype_11",
                     "Bo_animaltype_12","MCFpasture","MCFspread","MCFdrylot","MCFsolidstore","MCFcomposted","MCFliquid","MCFbiogas","MCFburn","MCFsold",
                     "mndec_pasture","mndec_spread","mndec_drylot","mndec_solidstore","mndec_composted","mndec_liquid","mnvc_pasture","mnvc_spread",
                     "mnvc_drylot","mnvc_solidstore","mnvc_composted","mnvc_liquid","frac_leach_pasture","frac_leach_spread","frac_leach_drylot",
                     "frac_leach_solidstore","frac_leach_composted","frac_leach_liquid")


precise_scenarios<-data.frame(Variable=c(variables_to_update_const,variables_to_update_posnorm,precise_estimates),param="both")
...
for (f in Farms)
  ...
  # update live weight and weight gain for each animal type (with error)
   ...
   precise_scenarios[which(precise_scenarios$Variable=="Ca_pasture"),coln]<-0.17
   precise_scenarios[which(precise_scenarios$Variable=="Ca_large_grazing"),coln]<-0.36
   precise_scenarios[which(precise_scenarios$Variable=="C_intact_males"),coln]<-1.2   
   precise_scenarios[which(precise_scenarios$Variable=="C_castrates"),coln]<-1.0   
   precise_scenarios[which(precise_scenarios$Variable=="C_females"),coln]<-0.8   
   precise_scenarios[which(precise_scenarios$Variable=="maintenance_coefficient_Cfi_other"),coln]<-0.322   
   precise_scenarios[which(precise_scenarios$Variable=="maintenance_coefficient_Cfi_lact_cow"),coln]<-0.386
   precise_scenarios[which(precise_scenarios$Variable=="maintenance_coefficient_Cfi_bulls"),coln]<-0.370
   precise_scenarios[which(precise_scenarios$Variable=="mature_weight_MW_female"),coln]<-349 
   precise_scenarios[which(precise_scenarios$Variable=="mature_weight_MW_male"),coln]<-483   
   precise_scenarios[which(precise_scenarios$Variable=="milk_fat"),coln]<-4 
   precise_scenarios[which(precise_scenarios$Variable=="Cp_rate_4"),coln]<-0.1  
   precise_scenarios[which(precise_scenarios$Variable=="Cp_rate_5"),coln]<-0.1   
   precise_scenarios[which(precise_scenarios$Variable=="Cp_rate_6"),coln]<-0.1
   precise_scenarios[which(precise_scenarios$Variable=="Y_m"),coln]<-0.06 

   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_1"),coln]<-0.13
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_2"),coln]<-0.13
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_3"),coln]<-0.13
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_4"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_5"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_6"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_7"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_8"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_9"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_10"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_11"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="Bo_animaltype_12"),coln]<-0.13   
   precise_scenarios[which(precise_scenarios$Variable=="MCFpasture"),coln]<-0.0047   
   precise_scenarios[which(precise_scenarios$Variable=="MCFspread"),coln]<-0.01
   precise_scenarios[which(precise_scenarios$Variable=="MCFdrylot"),coln]<-0.02     
   precise_scenarios[which(precise_scenarios$Variable=="MCFsolidstore"),coln]<-0.05
   precise_scenarios[which(precise_scenarios$Variable=="MCFcomposted"),coln]<-0.025
   precise_scenarios[which(precise_scenarios$Variable=="MCFliquid"),coln]<-0.8   
   precise_scenarios[which(precise_scenarios$Variable=="MCFbiogas"),coln]<-0.1085   
   precise_scenarios[which(precise_scenarios$Variable=="MCFburn"),coln]<-0.1   
   precise_scenarios[which(precise_scenarios$Variable=="MCFsold"),coln]<-0   
   precise_scenarios[which(precise_scenarios$Variable=="mndec_pasture"),coln]<-0.02   
   precise_scenarios[which(precise_scenarios$Variable=="mndec_spread"),coln]<-0   
   precise_scenarios[which(precise_scenarios$Variable=="mndec_drylot"),coln]<-0.02   
   precise_scenarios[which(precise_scenarios$Variable=="mndec_solidstore"),coln]<-0.01   
   precise_scenarios[which(precise_scenarios$Variable=="mndec_composted"),coln]<-0.01   
   precise_scenarios[which(precise_scenarios$Variable=="mndec_liquid"),coln]<-0.01   
   precise_scenarios[which(precise_scenarios$Variable=="mnvc_pasture"),coln]<-0.02
   precise_scenarios[which(precise_scenarios$Variable=="mnvc_spread"),coln]<-0.07
   precise_scenarios[which(precise_scenarios$Variable=="mnvc_drylot"),coln]<-0.3
   precise_scenarios[which(precise_scenarios$Variable=="mnvc_solidstore"),coln]<-0.45   
   precise_scenarios[which(precise_scenarios$Variable=="mnvc_composted"),coln]<-0.65   
   precise_scenarios[which(precise_scenarios$Variable=="mnvc_liquid"),coln]<-0.3   
   precise_scenarios[which(precise_scenarios$Variable=="frac_leach_pasture"),coln]<-0.24   
   precise_scenarios[which(precise_scenarios$Variable=="frac_leach_spread"),coln]<-0.24   
   precise_scenarios[which(precise_scenarios$Variable=="frac_leach_drylot"),coln]<-0.24   
   precise_scenarios[which(precise_scenarios$Variable=="frac_leach_solidstore"),coln]<-0.24   
   precise_scenarios[which(precise_scenarios$Variable=="frac_leach_composted"),coln]<-0.24  
   precise_scenarios[which(precise_scenarios$Variable=="frac_leach_liquid"),coln]<-0.24
...
*# THIS STILL NEEDS CHECKING - are all the units correct?*
...
The blue line represents a classic best-bet estimate based on default values in the IPCC guidelines and some context-specific reasonable guesses.
...
histo + geom_vline(data=farm5_emissions_precise$y, aes(xintercept=CO2eq_per_milk),color="blue", lwd=3)

ggsave("Fig_3_emission_density_farm5.png",width=5,height=3)
...
geom_histogram(aes(y=..density..), colour="black", fill="white")+
 geom_density(alpha=.2, fill="#FF6666") +
  ylab("Relative probability") +
    xlab(expression(Emission~intensity~of~milk~production~at~2000~kg~milk~per~capita~(kg~CO[2]*'-eq'~kg^-1)))

ggsave("Fig_7_emission_density_all_farms.png")
...
ggsave("Fig_8_probability_of_intensity_reduction.png", width=7,height=5)
...
ggsave("Fig_9_breeds.png", width=7,height=5)
...
ggsave("Fig_10_breed_reductions.png", width=7,height=5)
...
ggplot(data = decreased_emissions_probability, aes(Base_yield, yield_increase)) + geom_contour_filled(aes(z=probability)) +
  ...
  xlab("Baseline milk yield per head and year (kg)") +
  ylab("Milk yield increase per head and year (kg)") 
ggsave("Fig_11_breed_probability_of_intensity_reduction.png", width=7,height=5)
