...
```{r, warning=FALSE, fig.dim = c(8, 4), fig.cap="***Figure S2.*** *Observed distributions of milk yields for all cattle breeds encountered among dairy cows in a survey of livestock-keeping smallholder farms in Kenya.*"}
# breed intervention
...
ggsave("figures/Fig_S2_breeds.png", width=9,height=4)
...
```{r, fig.dim = c(8, 8), fig.cap="***Figure S2.*** *Intervention impact on per head milk production and greenhouse gas emissions intensity.*"}
...
```{r, fig.dim = c(8, 4), fig.cap="***Figure S3.*** *Influence of the breed composition of farm-scale dairy cow populations on changes in milk yield and emissions intensity of milk production in response to a breed upgrade intervention*."}
...
ggsave("figures/Fig_S3_breed_diagnostics.png",width=8,height=5)

```

```{r, fig.dim = c(8, 4), fig.cap="***Figure S4.*** *Influence of the percentage of unproductive bulls in a cattle herd on changes in milk yield and emissions intensity of milk production in response to a 'retiring unproductive bulls' intervention*."}
...
ggsave("figures/Fig_S4_nobull_diagnostics.png",width=8,height=5)

```



```{r, fig.dim = c(8, 4), fig.cap="***Figure S5.*** *Influence of the percentage of replacement males in a cattle herd on changes in milk yield and emissions intensity of milk production in response to a 'fewer replacement males' intervention*."}
...
ggsave("figures/Fig_S5_lessReplace_diagnostics.png",width=8,height=5)
...
interventions_summary_milk<-data.frame(Intervention=c("Breed upgrade",
...
interventions_end_summary_milk<-data.frame(Intervention=c("Breed upgrade",
                                                 "Retiring unproductive bulls",
                                                 "Fewer replacement males",
                                                 "Calliandra feed",
                                                 "Balanced diet",
...
ggsave("figures/Fig_S7_updated_probability_of_lower_emissions_intensity.png", width=10,height=5)
...
confidence_plot_stuff$variable <- factor(confidence_plot_stuff$variable,
                                         levels = c("Type I error - failure to reward 'Breed upgrade' adopters",
                             "Type I error - failure to reward 'Retire unproductive bulls' adopters",
                             "Type I error - failure to reward 'Fewer replacement males' adopters",
                             "Type I error - failure to reward 'Calliandra feed' adopters",
                             "Type I error - failure to reward 'Balanced diet' adopters",
                             "Type II error - rewarding non-adopters"),
                  labels = c("Type I - 'Breed upgrade'",
...
ggsave("figures/Fig_S10_erorr_types.png", width=7,height=12)

```

new sensitivity analysis

```{r, fig.dim = c(12, 4), fig.cap="***Figure S11.*** *Strength of the relationship of Monte Carlo model input variables with the emissions intensity of milk production, as indicated by the Variable-Importance-Score of a Partial Least Squares regression. This analysis is based on a*"}
...
ggsave("figures/Fig_S11_PLS_dairy_households_update.png", width=12,height=4)
```
