...
kable(emissions_summary[,c(4,1,2,3)], booktabs = TRUE,
      ...
      caption = "<p style='color:black'><i><b>Table S1.</b> Summary statistics of simulated greenhouse gas emissions from cattle across a population of cattle-keeping smallholder farms in Kenya</i></p>") %>% pack_rows(
...
kable(breed_milk_summary, col.names = c("Breed", "Number of dairy cows", "Daily milk yield (kg)", "Intervention factor"),
      caption = "<p style='color:black'><i><b>Table S2.</b> Mean milk yield across all dairy cow breeds encountered during a farm survey in Kenya</i></p>") %>%
