...
```{r scenario_sampler}
scenario_sampler<-function(base_estimate, scenarios, model_function, randomMethod = "calculate", functionSyntax="data.frameNames",
  ...
  verbosity = 0)
{
  ...
  for(scens in scenario_names)
  {
    ...
    scen_results<-mcSimulation(
      ...
      numberOfModelRuns = as.numeric(scenarios[which(scenarios[1,]=="Runs"),scens]),
