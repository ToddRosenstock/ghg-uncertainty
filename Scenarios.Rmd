...
We're defining the function as in the 'Greenhouse gas emissions model' document. Please look there for more inforamtion about the original model design.
...
GHG_simulation_scenarios<-scenario_sampler(base_estimate = "data/livestock_ghg_input_table.csv",
...
```{r}
pls_result <- plsr.mcSimulation(object = GHG_simulation_scenarios,
                  resultName = names(GHG_simulation_scenarios$y)[7], 
                  ncomp = 1)
```
