...
```{r, fig.dim = c(8, 5), fig.cap="***Figure 10.*** *Strength of the relationship of Monte Carlo model input variables with the emission intensity of milk production, as indicated by the Variable-Importance-in-the-Projection (VIP) score of a Partial Least Squares regression. We show only variables with VIP >0.8, a threshold that is often used for considering variables important.*"}
